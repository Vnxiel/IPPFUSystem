...
Route::controller(UserManager::class)->group(function () {
    ...
    Route::get('/login', 'showLoginForm')->name('login.form');  // Login form
...
Route::middleware(['auth', 'role:Admin'])->group(function () {
    Route::controller(AdminManager::class)->group(function () {
        ...
        Route::get('/admin/overview', 'overview')->name('admin.overview');
        Route::get('/admin/overview', 'getLocConOverview')->name('admin.overview');
