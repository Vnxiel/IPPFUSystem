...
function toggleOtherFund() {
    const value = document.getElementById('sourceOfFunds').value;
    document.getElementById('otherFundContainer').style.display = (value === 'Others') ? 'block' : 'none';
}

function toggleOtherContractor() {
    const value = document.getElementById('projectContractor').value;
    document.getElementById('othersContractorDiv').style.display = (value === 'Others') ? 'block' : 'none';
}
...
function calculateCompletionDate() {
    ...
    const startDate = document.getElementById('officialStart').value;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('officialStart')?.addEventListener('change', calculateCompletionDate);
