                    ...
                    <div class="container">
                        <div class="row mt-1">
                            <div class="col-12 d-flex flex-nowrap justify-content-center justify-content-md-between align-items-center overflow-auto">
                                ...
                                <div class="card m-1" style="width: 16rem; height: 8rem;">
                                    <div class="card-body text-center d-flex flex-column justify-content-between">
                                        <h6 class="card-title border-bottom fw-bolder fs-6 fs-md-5">Restaffing Balance</h6>
                                        <p class="card-text fs-5 fs-md-3 fw-bold pt-2 text-break" id="restaffingBalance">₱500,000,000</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    fetch("/projects/summary")
        ...
        .then(data => {
            ...
            if (data.status === "success" && data.data) {
                ...
                document.getElementById("restaffingBalance").textContent = `₱${summary.restaffingBalance}`;
            } else {
    ...
    if (e.target.classList.contains("overview-btn")) {
        ...
        .then(data => {
            if (data.success) {
                ...
                //  Redirect to staff.overview (correct Laravel route)
