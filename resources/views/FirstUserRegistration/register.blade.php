...
<body style="background-color: #F8F2DE;" class="montserrat">
            ...
            <div class="mx-auto d-block">
                <div class="card p-3 shadow-lg" style="width: 25rem;">
                    <div class="text-center">
                        <img src="{{ asset('img/temp_logo.png') }}" style="height:9rem; width:10rem"
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="ofmis_id"
                                                        id="ofmis_id" placeholder="OFMIS ID" required>
                                                    @error('ofmis_id') <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    <label for="fullname" class="form-label fw-bolder">Full
                                                        Name:</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="position"
                                                        id="position" aria-describedby="position" placeholder="Position"
                                                        required>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="username"
                                                        ...
                                                        required>
                                                    @error('username') <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="{{ asset('js/Account/register-systemAdmin.js') }}"></script>
</body>
