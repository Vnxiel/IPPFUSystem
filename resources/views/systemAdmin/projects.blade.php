                ...
                <div class="modal-body">
                    <form action="{{ route('projects.addProject') }}" id="addProjectForm" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-1">
                                    <label for="projectTitleDisplay" class="form-label">Project ID</label>
                                    <textarea class="form-control" id="projectTitleDisplay" name="projectTitleDisplay" rows="2"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="mb-1">
                                        ...
                                        <input type="number" class="form-control currency-input" id="revisedConstractCost"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="number" class="form-control currency-input" id="contractAmount"
                                        name="contractAmount">
                                </div>
                                <div class="mb-1">
                                    <label for="engineering" class="form-label">Engineering</label>
                                    <input type="number" class="form-control currency-input" id="engineering"
                                        name="engineering">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="number" class="form-control currency-input" id="contingency"
                                        name="contingency">
                                </div>
                                <div class="mb-1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="number" class="form-control currency-input" id="totalExpenditure"
