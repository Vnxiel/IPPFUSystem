                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <span class="badge bg-success text-white me-2"
                                                    style="font-weight: normal;">{{ $project['projectStatus'] ?? 'N/A' }}</span>
            ...
            <div class="col-md-12">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary btn-sm d-flex align-items-center gap-2 ms-auto" data-bs-toggle="modal"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <fieldset class="border p-3 mb-4 rounded shadow-sm">
                                    <legend class="float-none w-auto px-2 fw-bold text-primary">Fund Source
                                    </legend>
                            ...
                            <div class="col-md-6 font-base">
                                <fieldset class="border p-3 mb-4 rounded shadow-sm">
                                    <legend class="float-none w-auto px-2 fw-bold text-primary">Fund Utilization</legend>
                                    <div class="mb-3">
