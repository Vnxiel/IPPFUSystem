  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content shadow-lg border-0 rounded-4">
      ...
      <div class="modal-body text-center">
        ...
        <div class="mb-3 text-start">
          <label for="reviewerInputPosition" class="form-label fw-semibold">Position:</label>
          <input type="text" class="form-control" id="reviewedByInputPosition" placeholder="Enter position" />
        </div>
        ...
        <div class="mb-3 text-start">
          <label for="notedByInputPosition" class="form-label fw-semibold">Position:</label>
          <input type="text" class="form-control" id="notedByInputPosition" placeholder="Ente position" />
        </div>
      </div>
