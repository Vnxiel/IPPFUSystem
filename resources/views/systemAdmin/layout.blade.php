...
<body class="montserrat d-flex flex-column min-vh-100">
                        ...
                        <ul class="navbar-nav gap-lg-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu border-0 shadow-sm mt-2">
                                    <li>
                                        <a class="dropdown-item py-2 {{ Request::is('systemAdmin/trash') ? 'fw-bold text-primary' : '' }}"
                                            href="{{ url('/systemAdmin/trash') }}">
                                            <i class="fas fa-archive me-2"></i>Archive
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item py-2 {{ Request::is('systemAdmin/activityLogs') ? 'fw-bold text-primary' : '' }}"
                                            href="{{ url('/systemAdmin/activityLogs') }}">
    ...
    <script src="{{ asset('js/Projects/fetchselectionData.js') }}"></script>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex align-items-center gap-2">
                                <input type="date" id="dateRangeStart" class="form-control flex-grow-1"
                                    placeholder="Start Date">
                                <span>-</span>
                                <input type="date" id="dateRangeEnd" class="form-control flex-grow-1"
