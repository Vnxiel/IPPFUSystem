                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="position" aria-describedby="position" placeholder="Position" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label for="confirmPass" class="form-label fw-bolder">Confirm Password:</label>
                                                        <input type="text" class="form-control" id="confirmPass" aria-describedby="confirmPass" placeholder="confirmPass" required>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="row">
