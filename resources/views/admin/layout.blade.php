...
<html lang="en">
    ...
    <body class="montserrat d-flex flex-column min-vh-100">
                        ...
                        <div class="d-lg-flex align-items-center ms-auto gap-lg-3">
                            <ul class="navbar-nav gap-lg-2">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle px-3 py-2 rounded-3 {{ Request::is('admin/trash') ? 'fw-bold text-white' : '' }}"
        ...
        <script src="{{ asset('js/Account/admin-change-new_pass.js') }}"></script>
