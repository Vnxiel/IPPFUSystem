...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <a type="button" class="btn btn-danger btn-sm"aria-current="page" href="{{ url('/admin/projects') }}"><span class="fa fa-arrow-left"></span></a>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <button type="button" id="checkStatusBtn" class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#checkStatusModal">
                        Check Status
                    </button>
                </div>
            </div>
    ...
    @include('admin.modals.add-fund')
    @include('admin.modals.edit-project')
    @include('admin.modals.uploadFiles')
    @include('admin.modals.generate-report')
    @include('admin.modals.check-status')
